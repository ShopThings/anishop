...
class OrderBadgePolicy
{
     ...
     */
    public function view(User $user, OrderBadge $model): bool
    {
     ...
     */
    public function update(User $user, OrderBadge $model): bool
    {
        if ($user->id === $model->creator()?->id) return true;
     ...
     */
    public function delete(User $user, OrderBadge $model): bool
    {
     ...
     */
    public function restore(User $user, OrderBadge $model): bool
    {
        return $user->hasPermissionTo(
            PermissionHelper::permission(
                PermissionsEnum::UPDATE,
     ...
     */
    public function forceDelete(User $user, OrderBadge|Collection $model): bool
    {
        if ($user->hasPermissionTo(
            ...
            if ($model instanceof OrderBadge) {
