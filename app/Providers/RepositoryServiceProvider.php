...
class RepositoryServiceProvider extends ServiceProvider
{
    ...
    private function registerRepositories(): void
    {
        ...
        $this->app->bind(PeriodicRepositoryInterface::class, PeriodicRepository::class);
        ...
        $this->app->bind(GatewayPaymentRepositoryInterface::class, GatewayPaymentRepository::class);
    ...
    private function registerServices(): void
    {
        ...
        $this->app->bind(PeriodicServiceInterface::class, PeriodicService::class);
        ...
        $this->app->bind(GatewayPaymentServiceInterface::class, GatewayPaymentService::class);
