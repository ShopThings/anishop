<template>
                            ...
                            >
                                <div class="flex items-center gap-2">
                                    ...
                                    <router-link
                                        ...
                                        @click="close()"
                                    >
                                        <ArrowTopRightOnSquareIcon class="w-5 h-5 text-amber-600 group-hover:text-amber-300 mx-auto transition"/>
                                    </router-link>
                                </div>
                            </div>
                        </template>
    ...
    <VTransitionSlideFadeLeftX>
        ...
        >
            <ul
                dir="ltr"
                class="my-custom-scrollbar w-44 md:w-52 rounded-br-xl flex flex-col shrink-0 py-3 pr-1 bg-slate-100 text-right"
            ...
            >
                ...
                >
                    <button
                        type="button"
                        class="w-full text-right font-iranyekan-bold leading-relaxed py-3 px-4 text-sm block rounded-r-full hover:bg-slate-200 transition border-l-[3px] border-transparent"
                        :class="{'!bg-white !border-cyan-400 text-cyan-500 shadow-sm': activeMainMenu.id === category.id}"
                    >
                        {{ category.name }}
                    </button>
                </li>
            ...
            >
                <div
                    dir="rtl"
                    class="w-full flex items-center gap-1.5 mb-6"
                >
...
function setHeight() {
    if (mainCategoriesItems.value && subCategoriesItems.value) {
        const h = Math.min(height.value - 100, 400)
