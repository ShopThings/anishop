      ...
      <div class="flex flex-col gap-3 w-full">
        ...
        <div class="relative">
          ...
          >
            ...
            >
              <span :style="'background-color:' + status.color_hex + ';'"
                    class="rounded-full size-4 shadow border border-slate-100"></span>
...
function getPeriodData(selected = null) {
  ...
  AdminPanelDashboardAPI.getChartOrders(selectedPeriod.value.value, selectedStatus.value, {
    success(response) {
      chartData.value = {
