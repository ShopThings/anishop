<template>
  ...
  <div
    class="quick-access-link-container grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-2 pb-3 max-h-[400px] md:max-h-none my-custom-scrollbar"
