            ...
            <div class="w-full h-full flex flex-col justify-evenly">
              ...
              <div class="max-h-[64px] overflow-hidden">
                ...
                <div v-else class="flex items-center justify-between">
                  <template
                      v-if="slide.discounted_price && getPercentageOfPortion(slide.discounted_price, slide.price) > 0"
                  >
                    <div class="rounded-lg bg-rose-500 text-white text-sm py-1 px-2 my-1">
                      <span class="text-xs">%</span>
                      {{ getPercentageOfPortion(slide.discounted_price, slide.price) }}
                    </div>
                  </template>
                  ...
                  <div class="flex flex-col mr-3">
                    ...
                    <template v-if="slide.discounted_price">
