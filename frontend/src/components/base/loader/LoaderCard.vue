<template>
    <div role="status" class="bg-white max-w-sm p-4 border border-gray-200 rounded-lg shadow animate-pulse md:p-6 dark:border-gray-700">
        ...
        <div class="flex items-center mt-4 space-x-3 space-x-reverse">
