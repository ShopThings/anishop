<template>
  ...
  >
    ...
    <div class="h-2 bg-slate-200 rounded-full dark:bg-slate-700 mb-3"></div>
    <div class="h-2 bg-slate-200 rounded-full dark:bg-slate-700 w-5/6"></div>
    <div class="flex items-center justify-between mt-6 space-x-3 space-x-reverse">
      <div class="grow">
        <div class="h-2.5 bg-slate-200 rounded-full dark:bg-slate-700 w-1/2 mb-2"></div>
        <div class="w-3/4 h-2 bg-slate-200 rounded-full dark:bg-slate-700"></div>
      </div>
      <div class="flex gap-2">
        <div class="p-2 w-10 h-10 border-2 dark:border-slate-700 rounded-full">
          <ChevronRightIcon class="w-5 h-5 text-slate-300 dark:text-slate-700"/>
        </div>
        <div class="p-2 w-10 h-10 border-2 dark:border-slate-700 rounded-full">
          <ChevronLeftIcon class="w-5 h-5 text-slate-300 dark:text-slate-700"/>
        </div>
      </div>
    </div>
