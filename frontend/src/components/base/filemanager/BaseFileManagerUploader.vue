        ...
        <div class="block md:grid md:grid-cols-2 gap-3 mb-3">
            ...
            >
                ...
                >
                    ...
                    <span v-else-if="file.status === UploadTypes.FAILED" class="text-lg flex flex-col justify-center">
