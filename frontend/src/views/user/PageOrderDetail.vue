              ...
              <div class="flex flex-col">
                ...
                <div class="text-sm">
                  <template v-if="info?.coupon_price">
                    <span class="tracking-widest">{{ formatPriceLikeNumber(info?.coupon_price) }}</span>
          ...
          <partial-card class="border-0 p-3">
            <template #body>
              <div class="flex flex-col">
                ...
                <div class="text-sm">
                  <span class="tracking-widest">{{ formatPriceLikeNumber(info?.final_price) }}</span>
                  <span class="text-xs mr-1">تومان</span>
                </div>
              </div>
            </template>
              ...
              <div class="flex flex-col">
                ...
                <div class="text-sm">
                  <template v-if="info?.shipping_price && info?.shipping_price > 0">
                    <span class="tracking-widest">{{ formatPriceLikeNumber(info?.shipping_price) }}</span>
                    <span class="text-xs mr-1">تومان</span>
                  </template>
          ...
          <partial-card class="border-0 p-3">
            <template #body>
              <div class="flex flex-col">
                ...
                <div class="text-sm">
                  <span class="tracking-widest">{{ formatPriceLikeNumber(info?.total_price) }}</span>
                  <span class="text-xs mr-1">تومان</span>
                </div>
              </div>
            </template>
              ...
              <div class="flex flex-col">
                ...
                <div class="text-sm">
                  <span class="tracking-widest">{{
                      formatPriceLikeNumber(info?.total_price - info?.final_price)
                    }}</span>
                  <span class="text-xs mr-1">تومان</span>
                </div>
              </div>
        ...
        >
          ...
          <template #must_pay_price="{value}">
            <div class="text-lg font-iranyekan-bold">
              {{ formatPriceLikeNumber(value.must_pay_price) }}
...
function handleOrderItemOperation(product, item, hide) {
  ...
  if (item.operation === 'comment') {
    ...
    // TODO: add to cart with "product.product_code"
  }
}
