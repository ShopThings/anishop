        ...
        <div class="w-full px-4">
          <div class="mx-auto max-w-[400px] text-center">
            ...
            <router-link :to="{name: 'home'}"
                         class="hover:text-purple-500 inline-block rounded-lg border border-white px-8 py-3 text-center text-base font-semibold text-white transition hover:bg-white"
            >
              بازگشت
            </router-link>
          </div>
