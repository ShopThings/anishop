      ...
      <li class="pt-6 px-2 border-2 border-dashed border-slate-300 rounded-lg mb-3">
        <div class="flex flex-wrap items-end mt-2 relative mb-4">
          ...
          <base-button
            ...
            :class="[
                  'handle cursor-grab active:cursor-grabbing w-20 !rounded-t-none !rounded-br-none',
...
import {ArrowLeftCircleIcon, Bars2Icon, PlusIcon, TrashIcon,} from "@heroicons/vue/24/outline/index.js"
