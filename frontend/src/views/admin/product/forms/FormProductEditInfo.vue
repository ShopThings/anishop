...
onMounted(() => {
  ...
  //         selectedUnit.value = response.data.unit
  //         selectedBrand.value = response.data.brand
  //         selectedCategory.value = response.data.category
  //         selectedImage.value = response.data.image.path + '/' + response.data.image.name
  //         tags.value = response.info.keywords.split(',')
  //         babyProps.value = response.data.quick_properties
  //
  //         loading.value = false
  //     },
  // })
